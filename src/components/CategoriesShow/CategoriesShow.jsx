      ...
      <div className="row">
        {categoriesData.map((category, index) => (
          <div
            ...
            key={index}
          >
            <div className="d-flex flex-fow align-items-center w-100 p-3 border rounded shadow-sm bg-light">
              <NavLink
                to={`/category/${slugify(category.category)}`}
                className="d-flex flex-fow align-items-center w-100 text-decoration-none text-dark"
              >
