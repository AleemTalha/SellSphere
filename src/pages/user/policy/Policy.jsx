    ...
    <>
      ...
      <div className="policy-container">
        <div className="policy-content">
          ...
          <p>
            Welcome to SellSphere! These terms and conditions outline the rules
            and regulations for the use of our website and services.
          </p>
          <h2>1. Introduction</h2>
          <p>
            By accessing this website, we assume you accept these terms and
            conditions. Do not continue to use SellSphere if you do not agree to
            all of the terms and conditions stated on this page.
          </p>
          <h2>2. Intellectual Property Rights</h2>
          <p>
            Unless otherwise stated, SellSphere and/or its licensors own the
            intellectual property rights for all material on SellSphere. All
            intellectual property rights are reserved. You may access this from
            SellSphere for your own personal use subjected to restrictions set
          ...
          <p>
            ...
            website. By displaying User Content, you grant SellSphere a
          ...
          <p>
            In no event shall SellSphere, nor any of its officers, directors,
            ...
            is under contract. SellSphere, including its officers, directors,
          ...
          <p>
            You hereby indemnify to the fullest extent SellSphere from and
          ...
          <p>
            SellSphere is permitted to revise these terms at any time as it sees
            fit, and by using this website you are expected to review these
            terms on a regular basis.
          </p>
          <h2>9. Assignment</h2>
          <p>
            SellSphere is allowed to assign, transfer, and subcontract its
          ...
          <p>
            These terms constitute the entire agreement between SellSphere and
          ...
          <p>
            At SellSphere, accessible from [Your Website URL], one of our main
            priorities is the privacy of our visitors. This Privacy Policy
            document contains types of information that is collected and
            recorded by SellSphere and how we use it.
          </p>
          <h2>1. Log Files</h2>
          <p>
            SellSphere follows a standard procedure of using log files. These
          ...
          <p>
            Like any other website, SellSphere uses 'cookies'. These cookies are
          ...
          <p>
            ...
            advertising partners of SellSphere.
          </p>
          <p>
            Third-party ad servers or ad networks uses technologies like
            cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on SellSphere, which
          ...
          <p>
            Note that SellSphere has no access to or control over these cookies
            that are used by third-party advertisers.
          </p>
          <h2>6. Third Party Privacy Policies</h2>
          <p>
            SellSphere's Privacy Policy does not apply to other advertisers or
          ...
          <p>
            SellSphere does not knowingly collect any Personal Identifiable
          ...
          <p>
            ...
            that they shared and/or collect in SellSphere. This policy is not
